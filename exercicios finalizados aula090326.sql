...
/*4.6.	Exiba o nome do empregador, o nome do  empregado, o cpf do empregado e o motivo de afastamento do empregado apenas para os registros em que o empregado possui um afastamento.*/
select
	r.nome_empregador as empregadores,
    e.nome_empregado as empregados,
    a.motivo as motivo_afastamento,
    e.cpf_empregado as cpf
from
	afastamentos a
    join
    empregados e on e.id_empregado = a.id_empregado
    join
    empregadores r on e.id_empregador = r.id_empregador;
    
/*4.7.	Liste o nome do empregador e o tipo de acidente do empregado apenas para os registros em que o empregado possui uma Comunicação de Acidente de Trabalho (CAT)*/
select
	r.nome_empregador as empregadores,
    c.tipo_acidente as tipo_de_acidente
from
	cat c
    join
    empregados e on c.id_empregado = e.id_empregado
    join
    empregadores r on e.id_empregador = r.id_empregador;
...
select
	r.nome_empregador as empregadores,
    a.data_aviso as data_de_aviso
from
	avisoprevio a
	join
    empregados e on a.id_empregado = e.id_empregado
    join
    empregadores r on e.id_empregador = r.id_empregador;
...
select
	r.nome_empregador as empregadores,
    d.data_demissao as data_da_demissao
from
	demissao d
    join
    empregados e on d.id_empregado = e.id_empregado /*primeiro vem o d. e depois o e. -> e. e r.*/
    join
    empregadores r on e.id_empregador = r.id_empregador;
